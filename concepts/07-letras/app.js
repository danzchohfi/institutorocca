...
`)+`
`+p);let b=S+m+o,x=S+p+a,R=rd(i,i.VERTEX_SHADER,b),E=rd(i,i.FRAGMENT_SHADER,x);i.attachShader(_,R),i.attachShader(_,E),e.index0AttributeName!==void 0?i.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function T(I){if(r.debug.checkShaderErrors){let N=i.getProgramInfoLog(_).trim(),F=i.getShaderInfoLog(R).trim(),W=i.getShaderInfoLog(E).trim(),Z=!0,V=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(Z=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,R,E);else{let J=od(i,R,"vertex"),z=od(i,E,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
