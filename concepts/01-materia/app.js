...
#define LOW_PRECISION`),t}function ab(r){let t="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===Lm?t="SHADOWMAP_TYPE_PCF":r.shadowMapType===z0?t="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===Wi&&(t="SHADOWMAP_TYPE_VSM"),t}function lb(r){let t="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case ro:case so:t="ENVMAP_TYPE_CUBE";break;case Jl:t="ENVMAP_TYPE_CUBE_UV";break}return t}function cb(r){let t="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case so:t="ENVMAP_MODE_REFRACTION";break}return t}function hb(r){let t="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case Dm:t="ENVMAP_BLENDING_MULTIPLY";break;case rv:t="ENVMAP_BLENDING_MIX";break;case sv:t="ENVMAP_BLENDING_ADD";break}return t}function ub(r){let t=r.envMapCubeUVHeight;if(t===null)return null;let e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function fb(r,t,e,n){let i=r.getContext(),s=e.defines,o=e.vertexShader,a=e.fragmentShader,l=ab(e),c=lb(e),h=cb(e),d=hb(e),u=ub(e),f=jS(e),g=tb(s),_=i.createProgram(),m,p,b=e.glslVersion?"#version "+e.glslVersion+`
...
`)+`
`+m,p=["#define varying in",e.glslVersion===Fp?"":"layout(location = 0) out highp vec4 pc_fragColor;",e.glslVersion===Fp?"":"#define gl_FragColor pc_fragColor","#define gl_FragDepthEXT gl_FragDepth","#define texture2D texture","#define textureCube texture","#define texture2DProj textureProj","#define texture2DLodEXT textureLod","#define texture2DProjLodEXT textureProjLod","#define textureCubeLodEXT textureLod","#define texture2DGradEXT textureGrad","#define texture2DProjGradEXT textureProjGrad","#define textureCubeGradEXT textureGrad"].join(`
`)+`
`+p);let S=b+m+o,v=b+p+a,C=vm(i,i.VERTEX_SHADER,S),E=vm(i,i.FRAGMENT_SHADER,v);i.attachShader(_,C),i.attachShader(_,E),e.index0AttributeName!==void 0?i.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function T(P){if(r.debug.checkShaderErrors){let N=i.getProgramInfoLog(_).trim(),F=i.getShaderInfoLog(C).trim(),k=i.getShaderInfoLog(E).trim(),J=!0,W=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(J=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,C,E);else{let Z=ym(i,C,"vertex"),B=ym(i,E,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
